...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container d-flex flex-column align-items-center" data-aos="zoom-in" data-aos-delay="100">
            <h1>Wilbert Bernard Lo</h1>
            <h2>Just a Teenager who need a moment of break</h2>
    ...
    <footer id="footer">
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>Wilbert</span></strong>. All Rights Reserved
            </div>
        </div>
    </footer><!-- End  Footer -->
